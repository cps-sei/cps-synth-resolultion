...
#ifndef MISSIONAPP_AVERAGINGCOORDIATOR_H
#define MISSIONAPP_AVERAGINGCOORDIATOR_H
...
namespace cdra {
    ...
    class WeightedCoordinator : public Coordinator {

        // Weights of the enforcers
        std::map<StlEnforcer*, float> weights;

    public:
        WeightedCoordinator(std::shared_ptr<dronecode_sdk::Offboard> offboard,
                            std::shared_ptr<dronecode_sdk::Telemetry> telemetry);
        virtual ~WeightedCoordinator();
...
#endif //MISSIONAPP_AVERAGINGCOORDIATOR_H
