...
#ifndef MISSIONAPP_FLIGHTENFORCER_H
#define MISSIONAPP_FLIGHTENFORCER_H
...
namespace cdra {
    ...
    class FlightEnforcer : public StlEnforcer {
      
      // DTG = Distance to Ground
        DTGFun* dtgFun;
    ...
    public:
        FlightEnforcer(std::shared_ptr<dronecode_sdk::Offboard> offboard,
            std::shared_ptr<dronecode_sdk::Telemetry> telemetry,
            std::shared_ptr<StateStore> store);
        virtual ~FlightEnforcer();
    };

}

#endif //MISSIONAPP_FLIGHTENFORCER_H
